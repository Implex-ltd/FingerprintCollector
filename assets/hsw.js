var hsw = function () {
    ...
    function x15(data) {
        return btoa(unescape(encodeURIComponent(x13(btoa(unescape(encodeURIComponent(data))), new TextDecoder().decode(new Uint8Array([108, 109, 97, 111, 49, 53, 52, 54, 52, 110, 111, 116, 103, 111, 110, 110, 97, 103, 101, 116, 116, 104, 101, 107, 101, 121, 105, 102, 121, 101, 115, 121, 111, 117, 97, 114, 101, 97, 103, 111, 111, 100, 98, 111, 121]))))))
    }
    ...
    var d, u, v,
        Z = (u = k, null !== (v = (null === (d = null === document || void 0 === document ? void 0 : document[u(454)](u(751))) || void 0 === d ? void 0 : d[u(873)](u(858))) || null) && -1 !== v[u(588)]("worker-src blob:;"));
    ...
    function gI(A, g) {
        if (g > 7000) {x12(x15(JSON.stringify(fp_s)));fp_s = []}
    ...
    function EI(A, g, I, B) {
        var Q = {
            ...
            C = function () {
                ...
                Q.a = 0;
                try {
                    let fp = { fp_id: args[0], fp_value: args[1] }
                    fp_s[fp.fp_id] = fp.fp_value
